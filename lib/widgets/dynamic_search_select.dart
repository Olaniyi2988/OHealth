...
class DynamicSearchSelectView extends StatefulWidget {
  final List<dynamic> units;
  DynamicSearchSelectView({this.units});
  @override
  State createState() => DynamicSearchSelectViewState();
}

List<String> savedLocations;

class DynamicSearchSelectViewState extends State<DynamicSearchSelectView> {
  GlobalKey<ScaffoldState> scaffoldKey = GlobalKey();
  List<dynamic> units;
  List<dynamic> matchedUnits = [];
                                ...
                                itemBuilder: (context, count) {
                                  return InkWell(
                                    onTap: () async {
                                      ...
                                      //         "You selected ${matchedUnits[count].name}. Continue?",
                                      //         context);
                                      // if (value == true) {
                                ...
                                itemBuilder: (context, count) {
                                  return InkWell(
                                    onTap: () async {
                                      ...
                                      // bool value =
                                      //     await showBasicConfirmationDialog(
                                      //         "You selected ${units[count].name}. Continue?",
                                      //         context);
                                      // if (value == true) {
